...
from constants import LESSONSHOUR
...
def next_lessons(cours : dict, hour = int):
    hour_value = LESSONSHOUR[hour]
    next_lesson = cours[hour_value]
...
teste = lessons_TP("BUT1TD2TPD")
print(next_lessons(teste, 14))
